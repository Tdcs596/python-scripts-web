...
<head>
    ...
    <style>
        ...
        .main { max-width: 500px; margin: auto; border: 2px solid #ff0000; padding: 30px; background: #000; box-shadow: 0 0 30px #ff000055; border-radius: 10px; }
        textarea, input { width: 90%; background: #111; border: 1px solid #ff0000; color: #fff; padding: 12px; margin: 10px 0; border-radius: 5px; }
